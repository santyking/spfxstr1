...
import styles from './Spfxstr1WebPart.module.scss';
import * as strings from 'Spfxstr1WebPartStrings';
...
export default class Spfxstr1WebPart extends BaseClientSideWebPart<ISpfxstr1WebPartProps> {
  ...
  public render(): void {
    ...
    <section class="${styles.spfxstr1} ${!!this.context.sdks.microsoftTeams ? styles.teams : ''}">
